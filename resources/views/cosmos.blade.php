...
<body class="antialiased">
  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    ...
    <main>
        <div class="container py-4 text-white bg-primary text-white">
      ...
      <a href="/" class="d-flex align-items-center text-body-emphasis text-decoration-none">
        ...
        <span class="fs-4">Детский университет</span>
            ...
            <div class="my-5 px-3" id="info">
                <h1 class="pb-2 border-bottom">Что надо сделать?</h1>
                ...
                <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-3">
                    <div class="col">
                        <div class="card card-cover h-100 overflow-hidden text-bg-danger rounded-4 shadow-lg" style123="background-image: url('unsplash-photo-1.jpg');">
                            <div class="d-flex flex-column h-100 p-4 pb-3 text-white text-shadow-1">
                                <h3 class="pt-3 mt-2 mb-4 display-6 lh-1 fw-bold">Собирай</h3>
                                <div class="mb-3">Сборка моделей ракет, спутников, луноходов и вездеходов на каждом занятии</div>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                    ...
                    <div class="col">
                        <div class="card card-cover h-100 overflow-hidden text-bg-danger rounded-4 shadow-lg" style123="background-image: url('unsplash-photo-1.jpg');">
                            <div class="d-flex flex-column h-100 p-4 pb-3 text-white text-shadow-1">
                                <h3 class="pt-3 mt-2 mb-4 display-6 lh-1 fw-bold">Изучай</h3>
                                <div class="mb-3">Проходи специальные уроки с интересными фактами о космосе. Проходи тесты и набирай очки</div>
                            </div>
                        </div>
                    </div>
                    <div class="col">
            ...
            <div class="h-100 p-4 bg-body-tertiary text-black text-center border rounded-3 my-1 fs-1">
                Приходи на занятие! Преподаватель расскажет все подробности
            </div>



            <footer class="p-3 mt-4 text-white ">
